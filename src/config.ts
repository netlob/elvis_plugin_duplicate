export class Config {
     ...
     */
    static httpPort: string = process.env.IR_HTTP_PORT || '7090';
     ...
     */
    static elvisToken: string = process.env.IR_ELVIS_TOKEN || 'sTfic+QsbEAl1lIembasYg==';

    /**
     * Language to translate from. Default value is 'en' - English
     */
    static metadataTag: string = process.env.METADATA_TAG || 'cf_duplicate';
}